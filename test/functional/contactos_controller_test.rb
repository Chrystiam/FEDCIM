...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { apellido: @contacto.apellido, celular: @contacto.celular, email: @contacto.email, nombre: @contacto.nombre, telefono: @contacto.telefono }
    end
  ...
  test "should update contacto" do
    put :update, id: @contacto, contacto: { apellido: @contacto.apellido, celular: @contacto.celular, email: @contacto.email, nombre: @contacto.nombre, telefono: @contacto.telefono }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
